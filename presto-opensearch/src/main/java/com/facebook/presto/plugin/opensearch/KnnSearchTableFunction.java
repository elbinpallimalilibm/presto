        ...
        super(
                ...
                List.of(
                        ...
                        ScalarArgumentSpecification.builder()
                                .name("SPACE_TYPE")
                                .type(VARCHAR)
                                .defaultValue(Slices.utf8Slice("cosine"))
                                .build(),
                        ScalarArgumentSpecification.builder()
                                .name("EF_SEARCH")
                                .type(INTEGER)
