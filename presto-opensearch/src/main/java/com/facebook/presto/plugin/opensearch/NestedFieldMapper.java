...
public class NestedFieldMapper
{
    ...
    {
        Map<String, NestedFieldInfo> result = new java.util.LinkedHashMap<>();
            ...
            Map<String, NestedFieldInfo> result)
    {
        ...
        for (Map.Entry<String, Object> entry : properties.entrySet()) {
            ...
            // Get Presto type
            Type prestoType = TypeMapper.toPrestoType(fieldType, fieldProps, fieldName);
            ...
            if (isLeaf) {
                ...
                // Add parent field (object/nested type)
                NestedFieldInfo fieldInfo = new NestedFieldInfo(
                        fieldPath,
                        currentPath,
                        fieldName,
                        ...
                        newPathList);
                result.put(fieldPath, fieldInfo);
                log.debug("Discovered parent field: %s (type: %s, depth: %d)",
                         fieldPath, fieldType, depth);

                // Recurse into nested properties
                if (fieldProps.containsKey("properties")) {
                    Map<String, Object> nestedProps =
                            (Map<String, Object>) fieldProps.get("properties");
                    ...
                    log.debug("Object field %s has no properties defined", fieldPath);
                }
            }
        }
    }
