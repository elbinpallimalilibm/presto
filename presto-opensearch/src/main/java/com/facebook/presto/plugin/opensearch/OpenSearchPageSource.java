        ...
        implements ConnectorPageSource
{
            ...
            List<OpenSearchColumnHandle> columns)
    {
        ...
        this.nestedExtractor = new NestedValueExtractor();
    ...
    public Page getNextPage()
    {
        ...
        try {
            ...
            // Execute query
            List<Map<String, Object>> documents = client.executeQuery(
                    split.getIndexName(),
                    query,
                    fieldNames,
                    currentOffset,
            ...
            log.error(e, "Failed to fetch data from OpenSearch");
    ...
    private Page buildPage(List<Map<String, Object>> documents)
    {
        ...
        for (int columnIndex = 0; columnIndex < columns.size(); columnIndex++) {
            ...
            if (column.getColumnName().contains("date")) {
                System.out.println("DEBUG PageSource: column=" + column.getColumnName() + ", type=" + type);
            }
